...
export default function RecruteurFavorisPage() {
  return (
    <div className="max-w-3xl mx-auto text-center py-20">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-3">Favoris</h1>
      <p className="text-gray-500 mb-2">Cette page est en cours de construction 🚧</p>
      <p className="text-sm text-gray-400">Retrouvez ici les profils et offres sauvegardés.</p>
    </div>
  );
}
