    ...
    <>
      ...
      <main className="flex-1 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 mb-4">Foire aux Questions</h1>
          <p className="text-gray-500 mb-2">Cette page est en cours de construction 🚧</p>
          <p className="text-sm text-gray-400">Nous travaillons actuellement sur cette section. Revenez bientôt !</p>
        </div>
      </main>
      <Footer />
    </>
